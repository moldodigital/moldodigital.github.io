...
class __TwigTemplate_6b2e16bc91100fb7d09be35e1bfc8103b239a616f76a36f1ba44dbeee36e5b01 extends Twig_Template
{
    ...
    <div class=\"SummaryCardContainer\"> <div class=\"SummaryCard\">
         <img id=\"twittliveimg\" src=\"";
            // line 13
            echo twig_escape_filter($this->env, (($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["context"]) ? $context["context"] : null), "media", array(), "any", false, true), $this->getAttribute($this->getAttribute((isset($context["context"]) ? $context["context"] : null), "header", array()), "shareimg", array()), array(), "array", false, true), "url", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["context"]) ? $context["context"] : null), "media", array(), "any", false, true), $this->getAttribute($this->getAttribute((isset($context["context"]) ? $context["context"] : null), "header", array()), "shareimg", array()), array(), "array", false, true), "url", array()), $this->getAttribute(twig_first($this->env, $this->getAttribute($this->getAttribute((isset($context["context"]) ? $context["context"] : null), "media", array()), "images", array())), "url", array()))) : ($this->getAttribute(twig_first($this->env, $this->getAttribute($this->getAttribute((isset($context["context"]) ? $context["context"] : null), "media", array()), "images", array())), "url", array()))), "html", null, true);
            echo "\" width=\"100%\">
    <div class=\"cardtext\">
         <h2 class=\"cardtitle\" id=\"titletwtarget\">
         ";
            // line 16
            echo twig_escape_filter($this->env, (($this->getAttribute($this->getAttribute((isset($context["context"]) ? $context["context"] : null), "header", array(), "any", false, true), "twittertitle", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute((isset($context["context"]) ? $context["context"] : null), "header", array(), "any", false, true), "twittertitle", array()), (($this->getAttribute((isset($context["page"]) ? $context["page"] : null), "title", array()) . " | ") . $this->getAttribute((isset($context["site"]) ? $context["site"] : null), "title", array())))) : ((($this->getAttribute((isset($context["page"]) ? $context["page"] : null), "title", array()) . " | ") . $this->getAttribute((isset($context["site"]) ? $context["site"] : null), "title", array())))), "html", null, true);
            echo "
        </h2>
...
{% endif %}", "forms/fields/twitter/twitter.html.twig", "/Applications/XAMPP/xamppfiles/htdocs/grav-admin/user/plugins/seo/templates/forms/fields/twitter/twitter.html.twig");
    }
}
