...
return [
    ...
    'timestamp' => 1497541158,
    'checksum' => 'f9df1f95959d04d2599cf030afc1a8ad',
    'files' => [
        ...
        'user/plugins' => [
            ...
            'plugins/table-importer' => [
                'file' => 'user/plugins/table-importer/blueprints.yaml',
                'modified' => 1497540180
            ],
            'plugins/tablesorter' => [
                'file' => 'user/plugins/tablesorter/blueprints.yaml',
                'modified' => 1497541154
            ]
        ]
    ],
    'data' => [
        'items' => [
            ...
            'plugins.table-importer.enabled' => [
                'type' => 'toggle',
                'label' => 'Plugin status',
                'highlight' => 1,
                'default' => 0,
                ...
                'name' => 'plugins.table-importer.enabled',
                'validation' => 'strict'
            ],
            'plugins.tablesorter' => [
                'form' => [
            ...
            'plugins.tablesorter.enabled' => [
                ...
                'name' => 'plugins.tablesorter.enabled',
                'validation' => 'strict'
            ]
        ],
        'rules' => [
        ...
        'nested' => [
            ...
            'plugins' => [
                ...
                'table-importer' => [
                    'enabled' => 'plugins.table-importer.enabled'
                ],
                'tablesorter' => [
                    'enabled' => 'plugins.tablesorter.enabled'
                ]
            ]
        ],
        'dynamic' => [
