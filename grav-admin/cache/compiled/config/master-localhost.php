...
return [
    ...
    'checksum' => '70e9de8dd26ca8f6f02b599667880aae',
    'files' => [
        'user/config' => [
            'media' => [
            ...
            'plugins/table-importer' => [
                'file' => 'user/config/plugins/table-importer.yaml',
                'modified' => 1497540843
            ],
            'plugins/tablesorter' => [
                'file' => 'user/config/plugins/tablesorter.yaml',
                'modified' => 1497541158
            ],
            'security' => [
        ...
        'user/plugins' => [
            ...
            'plugins/table-importer' => [
                'file' => 'user/plugins/table-importer/table-importer.yaml',
                'modified' => 1497540180
            ],
            'plugins/tablesorter' => [
                'file' => 'user/plugins/tablesorter/tablesorter.yaml',
                'modified' => 1497541154
            ]
        ]
    ],
    'data' => [
        'plugins' => [
            ...
            'tablesorter' => [
                ...
                'production' => true,
                'custom_path' => 'assets/tablesorter',
                'themes' => 'blue',
                'table_nums' => 1
            ]
        ],
